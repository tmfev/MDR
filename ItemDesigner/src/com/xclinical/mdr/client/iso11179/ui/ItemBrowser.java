...
public class ItemBrowser extends Composite implements GenericEditor<Item>, HasWindow, HasItem, HasClipboardData {

	interface Binder extends UiBinder<Widget, ItemBrowser> {
