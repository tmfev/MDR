...
public final class AddFavouriteCommand extends AbstractCommand {
	...
	public void invoke(TreeWriter writer, TreeSource source) throws RemoteException {
		...
		User.addLink(obj.getKey(), ItemLink.TAG_FAVOURITES);

		User me = Session.get().getSubject();
		FlatJsonExporter.copy(writer, new ResultList(me.getFavourites()));		
	}
}
