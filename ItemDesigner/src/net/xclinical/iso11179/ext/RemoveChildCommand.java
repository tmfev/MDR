...
public final class RemoveChildCommand extends AbstractCommand {
	...
	public void invoke(TreeWriter writer, TreeSource source) throws RemoteException {
		obj = TreeBinding.bind(source.subNode("obj"));
		child = TreeBinding.bind(source.subNode("child"));

		obj.removeChild(child);

		FlatJsonExporter.copy(writer, obj);
	}
}
