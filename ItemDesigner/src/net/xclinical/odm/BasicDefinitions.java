...
public class BasicDefinitions {
	...
	private ElementCollection<MeasurementUnit> measurementUnits;
	
	public BasicDefinitions() {
		measurementUnits = new ElementCollection<MeasurementUnit>();
	}
	...
	public ElementCollection<MeasurementUnit> getMeasurementUnits() {
