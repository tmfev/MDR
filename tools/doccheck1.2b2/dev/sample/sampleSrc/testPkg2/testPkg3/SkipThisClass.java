...
package testPkg2.testPkg3;

import java.awt.event.*;
import java.io.*;
import java.util.*;
import java.net.URL;
// A class with no comment
public class SkipThisClass implements ActionListener
{
   protected int aVar;  // A variable with no comment

   /** A valid constructor. */
   public SkipThisClass() {
   }
    ...
    */
   public static void noParamTags(boolean b, int i, String s, Test1 t, Object o)
   { }
    ...
    * Missing @see tag.
    */
   public void addFooListener(Test1 x) { }

   /**
    * Missing @see tag.
    */
   public void removeFooListener(Test1 x) { }
