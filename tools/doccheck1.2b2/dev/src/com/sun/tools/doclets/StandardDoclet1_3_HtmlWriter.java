/*
 * @(#)StandardDoclet1_3_HtmlWriter.java	1.2  03/07/09
 * 
 ...
 */
public class StandardDoclet1_3_HtmlWriter extends PrintWriter {
     ...
     */
    public StandardDoclet1_3_HtmlWriter(String filename, String docencoding)
     ...
     * OutputStreamWriter is passed on to next level.
     */
    public StandardDoclet1_3_HtmlWriter(String path, String filename, String docencoding)
                      throws IOException, UnsupportedEncodingException {
